...
def _build_common_rules() -> str:
    ...
    '- 같은 성격의 역할 분담은 가능하면 하나의 결정사항으로 묶어 작성하세요.\n'
    '- decisions 문장은 참석자 이름 나열보다 어떤 방향으로 진행하기로 했는지가 드러나게 작성하세요.\n'
    '- 단순 작업 지시는 decisions보다 action_items에 넣으세요.\n'
    ...
    '- "A는 B가 준비", "C는 D가 담당", "E는 제가 정리"처럼 분야별 담당자가 나뉘는 문장은 각각 별도의 action_items로 분리하세요.\n'
